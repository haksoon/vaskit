class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def create
    ...
    if data[:email].blank?
    ...
    elsif data['birthday(1i)'].nil? || data['birthday(1i)'] == '' ||
          data['birthday(2i)'].nil? || data['birthday(2i)'] == '' ||
          data['birthday(3i)'].nil? || data['birthday(3i)'] == ''
      ...
      data[:birthday] = Date.new(data['birthday(1i)'].to_i,
                                 data['birthday(2i)'].to_i,
                                 data['birthday(3i)'].to_i)
      data[:string_id] = User.get_uniq_string_id(data[:email].split('@')[0])
      data[:remember_me] = true

      build_resource(email: data[:email],
  ...
  def check_email
    is_new_email = true if User.find_by_email(params[:email]).nil?
